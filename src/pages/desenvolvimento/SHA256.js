        ...
        <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
            <div className="p-card p-shadow-2" style={{
                ...
                <div style={{ marginBottom: '30px', textAlign: 'center' }}>
                    ...
                    <p style={{ color: '#666', fontSize: '14px' }}>Gere hash SHA256 de textos (implementação simplificada)</p>
                </div>
                ...
                {output && (
                    <div className="p-card p-shadow-1" style={{
                        ...
                        <strong style={{ color: '#667eea', marginBottom: '10px', display: 'block' }}>Hash SHA256:</strong>
                        <pre style={{
